<?php
	...
	if(isset($login))
	{
		$que=mysqli_query($con,"select * from admin where user='$email' and pass='$pass'");
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style = "padding:20px;">Admin Login - In</h3>
                    </div>
                    <div class="panel-body">
                        <form method="post" align = "center" style = "background-color:rgba(0,0,0,0.5); padding: 50px;">
                            <fieldset>
